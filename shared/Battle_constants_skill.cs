...
namespace shared {
    public partial class Battle {
        ...
        private static BulletConfig IcePillarStarterBullet = new BulletConfig(IcePillarRepeatingBullet).SetStartupFrames(10).SetSpeed(IcePillarRepeatingBullet.SpeedIfNotHit); 
