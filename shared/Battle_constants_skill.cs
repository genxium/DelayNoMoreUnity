...
namespace shared {
    public partial class Battle {
        ...
        private static BulletConfig MagicCannonBulletAir = new BulletConfig {
            ...
            Speed = (int)(8.5f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            DirX = 2,
            DirY = 0,
            Hardness = 8,
            RemainsUponHit = true,
        ...
        private static BulletConfig SlashNovaRepeatingBullet = new BulletConfig {
            StartupFrames = 10,
            ActiveFrames = 4*BATTLE_DYNAMICS_FPS,
            HitStunFrames = 20,
            BlockStunFrames = 9,
            Damage = 4,
            PushbackVelX = (int)(0f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
        ...
        public static BulletConfig HunterDragonPunchPrimerBullet = new BulletConfig {
            ...
            Damage = 12,
            PushbackVelX = (int)(0.5f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            PushbackVelY = (int)(0.3f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
        ...
        public static Skill HeatBeamAir = new Skill{
            Id = 51, 
            RecoveryFrames = 160,
            RecoveryFramesOnBlock = 160,
            RecoveryFramesOnHit = 160,
        ...
        public static Skill RidleyMeleeAir1 = new Skill {
            Id = 37,
            RecoveryFrames = 35,
            RecoveryFramesOnBlock = 35,
            RecoveryFramesOnHit = 35,
        ...
        public static BulletConfig RidleyMelee1Hit1 = new BulletConfig {
            ...
            ExplosionSfxName = "Melee_Explosion2",
            CollisionTypeMask = COLLISION_MELEE_BULLET_INDEX_PREFIX
        }.UpsertCancelTransit(PATTERN_B, RidleyMelee2.Id);

        public static Skill RidleyMelee1 = new Skill{
            Id = 38,
            RecoveryFrames = 35,
            RecoveryFramesOnBlock = 35,
            RecoveryFramesOnHit = 35,
        ...
        public static Skill WaterballAir = new Skill{
            Id = 36,
            RecoveryFrames = 32,
        ...
        public static Skill WaterballGround1 = new Skill{
            Id = 47, 
            RecoveryFrames = WaterballAir.RecoveryFrames + 10,
            RecoveryFramesOnBlock = WaterballAir.RecoveryFramesOnBlock + 10,
            RecoveryFramesOnHit = WaterballAir.RecoveryFramesOnHit + 10,
            MpDelta = WaterballAir.MpDelta,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = Atk2
        }
        ...
        public static Skill WaterballGround2 = new Skill{
            Id = 48, 
            RecoveryFrames = WaterballAir.RecoveryFrames,
            RecoveryFramesOnBlock = WaterballAir.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = WaterballAir.RecoveryFramesOnHit,
            MpDelta = WaterballGround1.MpDelta,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = Atk3
        }
        ...
        public static Skill RisingWaterballPair = new Skill {
            Id = 63,
            RecoveryFrames = WaterballGround1.RecoveryFrames,
            RecoveryFramesOnBlock = WaterballGround1.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = WaterballGround1.RecoveryFramesOnHit,
            MpDelta = 500,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = Atk2
        }
        ...
        public static Skill ThunderBolt = new Skill {
            Id = 49, 
            RecoveryFrames = 75,
            RecoveryFramesOnBlock = 75,
            RecoveryFramesOnHit = 75,
        ...
        public static BulletConfig SmallBallEmitterBeamHit1 = new BulletConfig {
            ...
            HitboxOffsetY = (int)(2f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeX = (int)(10*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeY = (int)(5*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            BeamRendering = true,
            BeamVisualSizeY = (int)(16*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO), // [WARNING] DON'T hardcode in Unity "AnimationCilp.GetComponent<SpriteRenderer>().size" or it'd cause weird rendering!
            SpeciesId = 24,
            ExplosionSpeciesId = 15,
            Speed = (int)(0f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
        ...
        public static BulletConfig BladeGirlSlidingHit1 = new BulletConfig(BasicSlidingHit1)
                                                              ...
                                                              .UpsertCancelTransit(PATTERN_B, BladeGirlSlidingSlashId)
                                                              .UpsertCancelTransit(PATTERN_DOWN_B, BladeGirlSlidingSlashId)
        ...
        public static BulletConfig HunterSlidingHit1 = new BulletConfig(BasicSlidingHit1)
                                                              ...
                                                              .UpsertCancelTransit(PATTERN_RELEASED_B, MobileThunderCannonPrimerId);
        ...
        .AddHit(
            new BulletConfig(BasicDashingHit1).UpsertCancelTransit(PATTERN_UP_B, HunterAirSlash.Id).UpsertCancelTransit(PATTERN_B, HunterPistolAir.Id).UpsertCancelTransit(PATTERN_DOWN_B, HunterPistolAir.Id).UpsertCancelTransit(PATTERN_RELEASED_B, MobileThunderCannonPrimerAirId)
        )
        .AddHit(
            new BulletConfig(BasicDashingHit2).UpsertCancelTransit(PATTERN_UP_B, HunterAirSlash.Id).UpsertCancelTransit(PATTERN_B, HunterPistolAir.Id).UpsertCancelTransit(PATTERN_DOWN_B, HunterPistolAir.Id).UpsertCancelTransit(PATTERN_RELEASED_B, MobileThunderCannonPrimerAirId)
        );
        ...
        public static BulletConfig DrakePrimerFireballBl1 = new BulletConfig {
            ...
            HitboxSizeY = (int)(20 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            SpeciesId = 38,
            ExplosionSpeciesId = 10,
            AnimLoopingRdfOffset = 12,
            Speed = (int)(3 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            DirX = 1,
            DirY = 0,
            Hardness = 10,
        ...
        public static Skill DrakePrimerAirFireball = new Skill {
            Id = 142,
            RecoveryFrames = DrakePrimerFireball.RecoveryFrames,
            RecoveryFramesOnBlock = DrakePrimerFireball.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = DrakePrimerFireball.RecoveryFramesOnHit,
            MpDelta = 550,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = InAirAtk1,
            SelfNonStockBuff = new BuffConfig {
        ...
        public static BulletConfig MobileThunderCannonPrimerBulletAir = new BulletConfig(MobileThunderCannonPrimerBullet).SetAllowsWalking(false).SetSelfLockVel(0, 0, NO_LOCK_VEL);
        ...
        .AddHit(MobileThunderCannonPrimerBullet);

        public static Skill MobileThunderCannonPrimerAir = new Skill {
            Id = 144,
            RecoveryFrames = MobileThunderCannonPrimer.RecoveryFrames,
            RecoveryFramesOnBlock = MobileThunderCannonPrimer.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = MobileThunderCannonPrimer.RecoveryFramesOnHit,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = InAirAtk1, 
        }
        .AddHit(MobileThunderCannonPrimerBulletAir);

        public static Skill MobileThunderCannonPrimerCrouch = new Skill {
            Id = 145, 
            RecoveryFrames = MobileThunderCannonPrimer.RecoveryFrames,
            RecoveryFramesOnBlock = MobileThunderCannonPrimer.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = MobileThunderCannonPrimer.RecoveryFramesOnHit,
        ...
        public static Skill MobileThunderCannonPrimerWall = new Skill {
            Id = 146,
            RecoveryFrames = MobileThunderCannonPrimer.RecoveryFrames,
            RecoveryFramesOnBlock = MobileThunderCannonPrimer.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = MobileThunderCannonPrimer.RecoveryFramesOnHit,
        ...
        public static uint SuccubusWhip1Id = 148, SuccubusWhip2Id = 149, SuccubusWhip1AirId = 150, SuccubusWhip2AirId = 151, SuccubusKickId = 152;
        public static BulletConfig SuccubusWhip1Hit1 = new BulletConfig {
            StartupFrames = 24,
            StartupInvinsibleFrames = 12,
            ActiveFrames = 12,
            HitStunFrames = 25,
            ...
            HitboxOffsetX = (int)(22*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxOffsetY = (int)(6*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeX = (int)(44*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeY = (int)(36*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            CancellableStFrame = 32,
            ...
            CharacterEmitSfxName = "SlashEmitSpd1",
            ExplosionSfxName = "Melee_Explosion2",
            GuardBreakerExtraHitCnt = 15,
            CollisionTypeMask = COLLISION_MELEE_BULLET_INDEX_PREFIX
        }.UpsertCancelTransit(PATTERN_B, SuccubusWhip2Id).UpsertCancelTransit(PATTERN_DOWN_B, SuccubusWhip2Id).UpsertCancelTransit(PATTERN_UP_B, SuccubusWhip2Id);

        public static BulletConfig SuccubusWhip2Hit1 = new BulletConfig {
            StartupFrames = 12,
            StartupInvinsibleFrames = 4,
            ActiveFrames = 13,
            HitStunFrames = MAX_INT,
            HitInvinsibleFrames = 30,
            BlockStunFrames = 20,
            Damage = 27,
            PushbackVelX = (int)(3.5f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            PushbackVelY = (int)(8f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            ...
            CharacterEmitSfxName = "SlashEmitSpd1",
            ExplosionSfxName = "Melee_Explosion2",
            GuardBreakerExtraHitCnt = 20,
            CollisionTypeMask = COLLISION_MELEE_BULLET_INDEX_PREFIX
        };

        public static BulletConfig SuccubusKickHit1 = new BulletConfig {
            StartupFrames = 18,
            StartupInvinsibleFrames = 12,
            ActiveFrames = 11,
            HitStunFrames = MAX_INT,
            ...
            BlockStunFrames = 20,
            Damage = 30,
            PushbackVelX = (int)(0.4f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            PushbackVelY = (int)(8.5f*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            SelfLockVelX = NO_LOCK_VEL,
            SelfLockVelY = NO_LOCK_VEL,
            SelfLockVelYWhenFlying = NO_LOCK_VEL,
            HitboxOffsetX = (int)(16*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxOffsetY = (int)(16*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeX = (int)(20*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            HitboxSizeY = (int)(38*COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            SpeciesId = 1,
            DirX = 1,
            DirY = 0,
            Hardness = 25,
            ...
            CharacterEmitSfxName = "SlashEmitSpd1",
            ExplosionSfxName = "Melee_Explosion2",
            GuardBreakerExtraHitCnt = 50,
            CollisionTypeMask = COLLISION_MELEE_BULLET_INDEX_PREFIX
        };

        public static Skill SuccubusWhip1 = new Skill {
            Id = SuccubusWhip1Id,
            RecoveryFrames = 45,
            RecoveryFramesOnBlock = 45,
            RecoveryFramesOnHit = 45,
        ...
        .AddHit(SuccubusWhip1Hit1);

        public static Skill SuccubusWhip2 = new Skill {
            Id = SuccubusWhip2Id,
            RecoveryFrames = 35,
            RecoveryFramesOnBlock = 35,
            RecoveryFramesOnHit = 35,
        ...
        .AddHit(SuccubusWhip2Hit1);

        public static BulletConfig SuccubusWhip1AirHit1 = new BulletConfig(SuccubusWhip1Hit1)
                                                        .SetSelfLockVel(0, 0, 0)
                                                        .UpsertCancelTransit(PATTERN_B, SuccubusWhip2AirId)
                                                        .UpsertCancelTransit(PATTERN_DOWN_B, SuccubusWhip2AirId)
                                                        .UpsertCancelTransit(PATTERN_UP_B, SuccubusWhip2AirId);
        public static BulletConfig SuccubusWhip2AirHit1 = new BulletConfig(SuccubusWhip2Hit1)
                                                        .SetSelfLockVel(0, 0, 0);

        public static Skill SuccubusWhip1Air = new Skill {
            Id = SuccubusWhip1AirId,
            RecoveryFrames = SuccubusWhip1.RecoveryFrames,
            RecoveryFramesOnBlock = SuccubusWhip1.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = SuccubusWhip1.RecoveryFramesOnHit,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = InAirAtk1
        }
        .AddHit(SuccubusWhip1AirHit1);

        public static Skill SuccubusWhip2Air = new Skill {
            Id = SuccubusWhip2AirId,
            RecoveryFrames = SuccubusWhip2.RecoveryFrames,
            RecoveryFramesOnBlock = SuccubusWhip2.RecoveryFramesOnBlock,
            RecoveryFramesOnHit = SuccubusWhip2.RecoveryFramesOnHit,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = InAirAtk2
        }
        .AddHit(SuccubusWhip2AirHit1);

        public static Skill SuccubusKick = new Skill {
            Id = SuccubusKickId,
            RecoveryFrames = 40,
            RecoveryFramesOnBlock = 40,
            RecoveryFramesOnHit = 40,
        ...
        .AddHit(SuccubusKickHit1);

        public static uint FlyingDemonFireballId = 153;
        public static BulletConfig FlyingDemonFireballBl1 = new BulletConfig {
            StartupFrames = 24,
            ActiveFrames = 420,
            HitStunFrames = 15,
            BlockStunFrames = 9,
        ...
        public static Skill FlyingDemonFireball = new Skill {
            Id = FlyingDemonFireballId,
            RecoveryFrames = 60,
            RecoveryFramesOnBlock = 60,
            RecoveryFramesOnHit = 60,
            MpDelta = 150,
        ...
        .AddHit(FlyingDemonFireballBl1);

        public static uint FireArrowId = 154;
        private static BulletConfig FireArrowBl = new BulletConfig {
            StartupFrames = 55,
            ActiveFrames = 180,
            HitStunFrames = MAX_INT,
            BlockStunFrames = 50,
            Damage = 26,
            PushbackVelX = (int)(3f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            PushbackVelY = (int)(6f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            SelfLockVelX = 0,
            SelfLockVelY = 0,
            SelfLockVelYWhenFlying = NO_LOCK_VEL,
            HitboxOffsetX = (int)(20 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            ...
            SpeciesId = 37,
            ExplosionSpeciesId = 2,
            Speed = (int)(6 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
            DirX = 2,
            DirY = 0,
            Hardness = 15,
            GuardBreakerExtraHitCnt = 20,
        ...
        public static Skill FireArrow = new Skill{
            Id = FireArrowId,
            RecoveryFrames = 62,
            RecoveryFramesOnBlock = 62,
            RecoveryFramesOnHit = 62,
            TriggerType = SkillTriggerType.RisingEdge,
            BoundChState = Atk1,
        }
        .AddHit(FireArrowBl); 
        ...
        public static ImmutableDictionary<uint, Skill> skills = ImmutableDictionary.Create<uint, Skill>().AddRange(
                ...
                new KeyValuePair<uint, Skill>(10, WitchGirlBackDashSkill),
                    ...
                    new KeyValuePair<uint, Skill>(WaterballAir.Id, WaterballAir),

                    new KeyValuePair<uint, Skill>(RidleyMeleeAir1.Id, RidleyMeleeAir1),

                    new KeyValuePair<uint, Skill>(RidleyMelee1.Id, RidleyMelee1),

                    new KeyValuePair<uint, Skill>(RidleyMelee2.Id, RidleyMelee2),

                    new KeyValuePair<uint, Skill>(RidleyMelee3.Id, RidleyMelee3),
                    ...
                    new KeyValuePair<uint, Skill>(WaterballGround1.Id, WaterballGround1),
                    new KeyValuePair<uint, Skill>(WaterballGround2.Id, WaterballGround2),
                    new KeyValuePair<uint, Skill>(ThunderBolt.Id, ThunderBolt),

                    new KeyValuePair<uint, Skill>(HeatBeamAir.Id, HeatBeamAir),
                    ...
                    new KeyValuePair<uint, Skill>(RisingWaterballPair.Id, RisingWaterballPair),
                    new KeyValuePair<uint, Skill>(FallingWaterballPair.Id, FallingWaterballPair),
                    new KeyValuePair<uint, Skill>(GhostHorseSkill.Id, GhostHorseSkill),
                    ...
                    new KeyValuePair<uint, Skill>(BladeGirlSlidingSlashId, BladeGirlSlidingSlashSkill),
                    ...
                    new KeyValuePair<uint, Skill>(PurpleArrowPrimarySkillAir.Id, PurpleArrowPrimarySkillAir),
                    new KeyValuePair<uint, Skill>(FallingPurpleArrowSkillAir.Id, FallingPurpleArrowSkillAir),
                    new KeyValuePair<uint, Skill>(RisingPurpleArrowSkillAir.Id, RisingPurpleArrowSkillAir),
                    ...
                    new KeyValuePair<uint, Skill>(MobileThunderCannonPrimer.Id, MobileThunderCannonPrimer),
                    ...
                    new KeyValuePair<uint, Skill>(SuccubusWhip1Id, SuccubusWhip1),
                    new KeyValuePair<uint, Skill>(SuccubusWhip2Id, SuccubusWhip2),
                    new KeyValuePair<uint, Skill>(SuccubusWhip1AirId, SuccubusWhip1Air),
                    new KeyValuePair<uint, Skill>(SuccubusWhip2AirId, SuccubusWhip2Air),
                    new KeyValuePair<uint, Skill>(SuccubusKickId, SuccubusKick),
                    new KeyValuePair<uint, Skill>(FlyingDemonFireballId, FlyingDemonFireball),
                    new KeyValuePair<uint, Skill>(FireArrowId, FireArrow),
                }
        );
                            ...
                            if (!notRecovered) {
                                if (currCharacterDownsync.InAir) {
                                    ...
                                    if (isCrouching(currCharacterDownsync.CharacterState, chConfig)) {
                                        return BladeGirlCrouchSlashId;
                                    } else {
                                        return BladeGirlGroundSlash1Id;
                                    }
                                }
                            } else {
                            ...
                            if (!notRecovered) {
                                if (currCharacterDownsync.InAir) {
                                    if (PATTERN_UP_B == patternId) {
                                        return RisingWaterballPair.Id;
                                    } else if (PATTERN_DOWN_B == patternId) {
                                        return FallingWaterballPair.Id;
                                    } else {
                                        return 36; // fallback
                                    }
                                } else {
                                    if (PATTERN_UP_B == patternId) {
                                        ...
                                        return WaterballGround1.Id; // fallback
                    ...
                    switch (patternId) {
                        case PATTERN_RELEASED_B:
                            ...
                            if (!notRecovered) {
                                if (currCharacterDownsync.InAir) {
                                    if (OnWallIdle1 == currCharacterDownsync.CharacterState) {
                                        return MobileThunderCannonPrimerWallId;
                                    } else {
                                        return MobileThunderCannonPrimerAirId;
                                    }
                                } else {
                                    if (isCrouching(currCharacterDownsync.CharacterState, chConfig)) {
                                        return MobileThunderCannonPrimerCrouchId;
                                    } else {
                                        return MobileThunderCannonPrimerId;
                                    }
                                }
                            } else {
                                // [WARNING] Combo in air is possible for this character!
                    ...
                    switch (patternId) {
                        ...
                        case PATTERN_UP_B:
                            if (!notRecovered) {
                                if (currCharacterDownsync.InAir) {
                                    // A fallback to "InAirAtk2"
                                    return RidleyMeleeAir1.Id; 
                                } else {
                                    return RidleyMelee1.Id;
                                }
                            } else {
                                if (currCharacterDownsync.InAir) {
                                    // [WARNING] No air combo for this character!
                ...
                case SPECIES_SUCCUBUS:
                    switch (patternId) {
                        ...
                        case PATTERN_DOWN_B:
                            if (!notRecovered) {
                                if (currCharacterDownsync.InAir) {
                                    return SuccubusWhip1AirId;
                                } else {
                                    return SuccubusWhip1Id;
                                }
                            } else {
                                // Now that "0 < FramesToRecover", we're only able to fire any skill if it's a cancellation
                                var (currSkillConfig, currBulletConfig) = FindBulletConfig(currCharacterDownsync.ActiveSkillId, currCharacterDownsync.ActiveSkillHit);
