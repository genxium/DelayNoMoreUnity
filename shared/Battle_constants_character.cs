        ...
        public static ImmutableDictionary<int, CharacterConfig> characters = ImmutableDictionary.Create<int, CharacterConfig>().AddRange(
                new[]
                {
                    ...
                    new KeyValuePair<int, CharacterConfig>(SPECIES_DEMON_FIRE_SLIME, new CharacterConfig {
                        ...
                        DefaultSizeY = (int)(65 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        ...
                        LayDownSizeY = (int)(65 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        DyingSizeX = (int)(50 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        DyingSizeY = (int)(65 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        MpRegenRate = 1,
                        CollisionTypeMask = COLLISION_CHARACTER_INDEX_PREFIX,
                        HasTurnAroundAnim = false,
                        HasDimmedAnim = true,
                    ...
                    new KeyValuePair<int, CharacterConfig>(SPECIES_SKELEARCHER, new CharacterConfig {
                        ...
                        DownSlopePrimerVelY = (int)(-0.8f * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        JumpingInitVelY = (int)(8.0 * COLLISION_SPACE_TO_VIRTUAL_GRID_RATIO),
                        InertiaFramesToRecover = 8,
