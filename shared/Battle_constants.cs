...
namespace shared {
    public partial class Battle {
        ...
        public static HashSet<ulong> COLLIDABLE_PAIRS = new HashSet<ulong>() {
            ...
            COLLISION_VISION_INDEX_PREFIX | COLLISION_TRAP_INDEX_PREFIX | COLLISION_BARRIER_FREE_INDEX_PREFIX | COLLISION_REFRACTORY_INDEX_PREFIX,
            COLLISION_VISION_INDEX_PREFIX | COLLISION_TRAP_INDEX_PREFIX | COLLISION_BARRIER_INDEX_PREFIX | COLLISION_REFRACTORY_INDEX_PREFIX,
