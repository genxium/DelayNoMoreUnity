...
namespace shared {
  ...
  public static partial class RoomDownsyncFrameReflection {
    ...
    static RoomDownsyncFrameReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Chlyb29tX2Rvd25zeW5jX2ZyYW1lLnByb3RvEgZzaGFyZWQivQUKDlBsYXll",
            ...
            "b1JlY292ZXIYDyABKAUSCgoCaHAYECABKAUSDQoFbWF4SHAYESABKAUSFgoO",
            "Y2hhcmFjdGVyU3RhdGUYEiABKAUSDQoFaW5BaXIYEyABKAgSFwoPZnJhbWVz",
            "SW5DaFN0YXRlGBQgASgFEhUKDWFjdGl2ZVNraWxsSWQYFSABKAUSFgoOYWN0",
            "aXZlU2tpbGxIaXQYFiABKAUSGAoQZnJhbWVzSW52aW5zaWJsZRgXIAEoBRIU",
            "CgxidWxsZXRUZWFtSWQYGCABKAUSGQoRY2hDb2xsaXNpb25UZWFtSWQYGSAB",
            "KAUSDgoGb25XYWxsGBogASgIEhMKC29uV2FsbE5vcm1YGBsgASgFEhMKC29u",
            "V2FsbE5vcm1ZGBwgASgFEhkKEWNhcHR1cmVkQnlJbmVydGlhGB0gASgIEhsK",
            "E3Jldml2YWxWaXJ0dWFsR3JpZFgYHiABKAUSGwoTcmV2aXZhbFZpcnR1YWxH",
            "cmlkWRgfIAEoBRINCgRuYW1lGOUHIAEoCRIUCgtkaXNwbGF5TmFtZRjmByAB",
            ...
            "EQoJaW5wdXRMaXN0GAIgAygEEhUKDWNvbmZpcm1lZExpc3QYAyABKAQiKgoP",
            "SGVhcnRiZWF0VXBzeW5jEhcKD2NsaWVudFRpbWVzdGFtcBgBIAEoAyLqAQoF",
            "V3NSZXESDQoFbXNnSWQYASABKAUSEAoIcGxheWVySWQYAiABKAUSCwoDYWN0",
            "GAMgASgFEhEKCWpvaW5JbmRleBgEIAEoBRIVCg1hY2tpbmdGcmFtZUlkGAUg",
            "ASgFEhoKEmFja2luZ0lucHV0RnJhbWVJZBgGIAEoBRIPCgdhdXRoS2V5GAcg",
            "ASgFEjcKFWlucHV0RnJhbWVVcHN5bmNCYXRjaBgIIAMoCzIYLnNoYXJlZC5J",
            "bnB1dEZyYW1lVXBzeW5jEiMKAmhiGAkgASgLMhcuc2hhcmVkLkhlYXJ0YmVh",
            "dFVwc3luYyK6AQoUSW5wdXRzQnVmZmVyU25hcHNob3QSGAoQcmVmUmVuZGVy",
  ...
  #endif
  {
    ...
    public const int InAirFieldNumber = 19;
    private bool inAir_;
    /// <summary>
    ...
    public const int FramesInChStateFieldNumber = 20;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (CharacterState != 0) {
        ...
        output.WriteInt32(CharacterState);
      }
      if (InAir != false) {
    ...
    public int CalculateSize() {
      ...
      if (CharacterState != 0) {
        size += 2 + pb::CodedOutputStream.ComputeInt32Size(CharacterState);
      }
      if (InAir != false) {
        size += 2 + 1;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 144: {
            CharacterState = input.ReadInt32();
            break;
          }
          case 152: {
