...
public class NetworkDoctorInfo: MonoBehaviour {
    ...
    public void SetValues(float sendingFps, float srvDownsyncFps, float peerUpsyncFps, int ifdLag, int stepsLocked, int rollbackFrames, long udpPunchedCnt) {
        ...
        float a1 = indicatorBaseAlpha + (NetworkDoctor.Instance.chasedToPlayerRdfIdIndicatorCountdown/NetworkDoctor.Instance.DEFAULT_INDICATOR_COUNTDOWN_RDF_CNT)*(1.0f - indicatorBaseAlpha);
        ...
        float a2 = indicatorBaseAlpha + (NetworkDoctor.Instance.forceResyncImmediatePumpIndicatorCountdown / NetworkDoctor.Instance.DEFAULT_INDICATOR_COUNTDOWN_RDF_CNT) * (1.0f - indicatorBaseAlpha);
        ...
        float a3 = indicatorBaseAlpha + (NetworkDoctor.Instance.forceResyncFutureAppliedIndicatorCountdown / NetworkDoctor.Instance.DEFAULT_INDICATOR_COUNTDOWN_RDF_CNT) * (1.0f - indicatorBaseAlpha);
